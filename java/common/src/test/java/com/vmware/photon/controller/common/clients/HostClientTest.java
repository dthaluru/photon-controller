...
public class HostClientTest {
  ...
  public class TransferImageTest {
    ...
    public void testSuccess() throws Exception {
      ...
      final Host.AsyncSSLClient.transfer_image_call transferImageCall = mock(Host.AsyncSSLClient.transfer_image_call.class);
  ...
  public class CreateImageTest {
    ...
    public void testSuccess() throws Exception {
      ...
      final Host.AsyncSSLClient.finalize_image_call createImageCall = mock(Host.AsyncSSLClient.finalize_image_call.class);
    ...
    @Test
    public void testFailureTExceptionOnGetResult() throws Exception {
      final Host.AsyncSSLClient.finalize_image_call finalizeImageCall = mock(Host.AsyncSSLClient.finalize_image_call.class);
