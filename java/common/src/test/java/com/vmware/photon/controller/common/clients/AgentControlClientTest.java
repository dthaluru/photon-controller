...
public class AgentControlClientTest {
  ...
  public class ProvisionTest {
    ...
    public void testSuccess() throws Exception {
      ...
      final AgentControl.AsyncSSLClient.provision_call provisionCall = mock(AgentControl.AsyncSSLClient.provision_call.class);
  ...
  public class GetAgentStatusTest {
    ...
    private Answer getAnswer(final AgentControl.AsyncSSLClient.get_agent_status_call getAgentStatusCall) {
      return new Answer() {
        ...
        public Object answer(InvocationOnMock invocation) throws Throwable {
          Object[] args = invocation.getArguments();
          AsyncMethodCallback<AgentControl.AsyncSSLClient.get_agent_status_call> handler = (AsyncMethodCallback) args[0];
